...
const MODULE = IF_ELSE_MODULES.find(m => m.id === '12-story')!

export default function StoryPage() {
  return (
    <ModulePage module={MODULE}>
      <motion.div variants={staggerChild} className='space-y-6'>
        {/* ── Coming in Phase 3: Story Learning ── */}
        <div className='flex flex-col items-center justify-center min-h-[40vh] gap-6 text-center'>
          ...
          <div className='space-y-2'>
            <h2 className='text-xl font-semibold text-white/85'>Part 12 — Story Learning</h2>
            <p className='text-white/40 text-sm max-w-md'>
              গল্পে শেখা — This module is being built. Check back soon!
            </p>
          </div>
