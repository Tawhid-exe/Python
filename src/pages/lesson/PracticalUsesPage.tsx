...
const FUNNY_EXAMPLES = [
  {
    titleEn: "Program 5: Mom's Anger Level Checker",
    titleBn: "প্রোগ্রাম ৫: মায়ের রাগের মাত্রা পরীক্ষক",
  ...
  {
    titleEn: "Program 6: Midnight Snack Checker",
    titleBn: "প্রোগ্রাম ৬: মাঝরাতে খাওয়ার পরীক্ষক",
      ...
      <motion.div variants={staggerChild} className="space-y-8 mt-6">
        ...
        <div className="space-y-6 pt-4">
          <h2 className="text-2xl font-bold text-white/90 text-center">
            {language === 'bn' ? 'বোনাস: বাস্তব জীবনের মজার উদাহরণ 😂' : 'Bonus: Practical Funny Examples 😂'}
          </h2>
